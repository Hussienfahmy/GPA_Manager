...
// Background-sync scheduling (SyncWorkerUpload, Android-only WorkManager) is registered
// separately in syncWorkerModule (androidMain) - this module stays platform-agnostic.
