...
@Composable
private fun AddSubjectSheetShowcase() {
    Column(
        modifier = Modifier
        ...
        AddSubjectSheetContent(
            availableGrades = Grade.generateInitialData(),
            subjectSettings = SubjectSettings(
...
private fun AddSubjectSheetLightPreview() {
    MeadowTheme(darkTheme = false) { AddSubjectSheetShowcase() }
}

@Preview(name = "AddSubjectSheet · dark", showBackground = true)
@Composable
private fun AddSubjectSheetDarkPreview() {
    MeadowTheme(darkTheme = true) { AddSubjectSheetShowcase() }
}
